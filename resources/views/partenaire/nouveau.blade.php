                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                            <div class="form-group"><div class="form-line">
                                    <input type="text" name="raisonsociale" id="raisonsociale" class="form-control" placeholder="Nom de l'entreprise" value="{{ old('raisonsociale') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="comptecontribuable" id="comptecontribuable" class="form-control" placeholder="N° Compte contribuable" value="{{ old('comptecontribuable') }}">
                                </div>
                            </div>
                        </div>
                    </div>
