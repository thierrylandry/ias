                ...
                <div class="card">
                    <div class="header">
                        <div class="row clearfix">
                            ...
                            <div class="col-md-2">
                                @if(\Illuminate\Support\Facades\Auth::user()->authorizes(\App\Service::DG, \App\Service::INFORMATIQUE) && !in_array($piece->statut, [\App\Statut::PIECE_COMPTABLE_BON_COMMANDE_VALIDE ]))
                        ...
                        <div class="p-r-10 p-l-10">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-6 col-xs-6">
                                    ...
                                    @if($piece->statut == \App\Statut::PIECE_COMPTABLE_BON_COMMANDE_VALIDE )
