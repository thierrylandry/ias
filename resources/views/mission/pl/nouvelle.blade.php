                    ...
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" required name="datedebut" id="datedebut" class="datepicker form-control" placeholder="JJ/MM/AAAA" value="{{old('datedebut',\Carbon\Carbon::now()->format("d/m/Y"))}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" required name="destination" id="destination" class="form-control" data-role="tagsinput" value="{{old("destination")}}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <select type="text" name="chauffeur_id" id="chauffeur_id" class="form-control input-field" data-live-search="true" required>
                                        ...
                                        @foreach($chauffeurs as $chauffeur)
                                            <option id="chauff_{{$chauffeur->employe_id}}" value="{{ $chauffeur->employe_id }}" @if(old('chauffeur_id') == $chauffeur->employe_id) selected @endif>{{ $chauffeur->employe->nom }} {{ $chauffeur->employe->prenoms }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                <div class="input-group">
                                    <div class="form-line">
                                        <input type="number" placeholder="Distance en kilomètre" required name="kilometrage" id="kilometrage" class="form-control" value="{{ old("kilometrage") }}"/>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-7">
                                <div class="input-group">
                                    <div class="form-line">
                                        <input type="number" placeholder="Montant du carburant" required name="carburant" id="carburant" class="form-control"  value="{{ old("carburant") }}"/>
                                    </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea name="observation" id="observation" class="form-control" placeholder="Observations de la mission" >{{ old('observation') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
